...
SECRET_KEY = 'iw45ackt4t00(fs!fkmgdde!9=^x)ge*=a83vu&!x#i5^hi*nq'
...
MEDIA_URL = '/media/'#creacion de la carpate media donde estaran las fotos de los animales
#datos importantes para la importacion de las imagenes de los animales 
...
EMAIL_PORT = 25
EMAIL_HOST_USER = 'tomasmatias9@gmail.com'
EMAIL_HOST_PASSWORD = 'airsoftacr123'#porfavor no jugar con el correo electronico es personal y lo muestro solo por motivos del ramo
